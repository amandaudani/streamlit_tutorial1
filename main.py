...
st.markdown("this is the heder")
st.subheader("this is subheder")
...
container.write("this is writing inside the conteiner")
st.write("this is writing outside the container")
